...
import { MicrophoneIcon, StopIcon, SendIcon, RobotIcon, UserIcon, CameraIcon } from './Icons';
...
export const InterviewScreen: React.FC<InterviewScreenProps> = ({
  ...
  useEffect(() => {
    ...
    let greetingText = "";
    if (hour < 12) {
      greetingText = "Good morning! 🌅 Ready to ace your interview?";
    } else if (hour < 17) {
      greetingText = "Good afternoon! ☀️ Let's make this interview amazing!";
    } else {
      greetingText = "Good evening! 🌙 Time to shine in your interview!";
    }
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Greeting Banner */}
      {greeting && (
        <div className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white p-4 text-center shadow-lg">
          <h2 className="text-2xl font-bold mb-1">{greeting}</h2>
          <p className="text-cyan-100">Show your best self and let's practice!</p>
        </div>
      )}
